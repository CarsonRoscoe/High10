...
namespace High10.CustomControls {
    public class LandingPageLogIn : Grid {
        ...
        public LandingPageLogIn(object bindingContext) {
            Margin = 8;
            ...
            logInButton.SetBinding(Button.CommandProperty, new Binding("LogInButtonCommand"));
